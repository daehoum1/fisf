...
Modified by Daeho Um (daehoum@uos.ac.kr)
"""
...
def run(args):
    ...
    for seed in seeds[: args.n_runs]:
        ...
        filled_features = cdfi3(data.edge_index, x, missing_feature_mask, args.num_iterations, args.mask_type,
